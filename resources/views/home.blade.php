                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="posts-block standard-box">
                                ...
                                @for ($i = 0; $i < 6; $i+=2)
                                    @include('home.lasted_new', ['new' => $top_news[$i] , 'new_2' => $top_news[$i+1]])
                                @endfor
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="news-post standart-post">
                                            <div class="post-image">
                                                <a href="single-post-2.html">
                                                    <img src="{{ $top_news[6]->image }}" alt="">
                                                </a>
                                            <a href="#" class="category category-travel">{{$top_news[6]->category_ref}}</a>
                                            </div>
                                            <h2><a href="single-post.html">{{$top_news[6]->title}}</a></h2>
                                            <ul class="post-tags">
                                                    <li><i class="lnr lnr-user"></i>{{__("by ")}}<a href="#">{!! $top_news[6]->user->firstname !!}</a></li>
                                                <li><a href="#"><i class="lnr lnr-book"></i><span>23 comments</span></a></li>
                                                <li><i class="lnr lnr-eye"></i>872 Views</li>
                                            </ul>
                                            <p>{!! \Illuminate\Support\Str::words(strip_tags($top_news[6]->description), 15, '...') !!}</p>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <h2>{{__("More ...")}}</h2>
                                        <ul class="list-news">
                                            @for ($i = 7; $i < count($top_news); $i++)
                                                <li>
                                                    <h2><a href="single-post.html">{{$top_news[$i]->title}}</a></h2>
                                                </li>
                                            @endfor
                                        </ul>
                                    </div>
